...
class DB_Driver_mysql extends DB_Driver
{
	...
	public function prepare($statement)
	{
		...
		try {
			...
			throw new DatabaseException('Database Prepare Failed: '.nl2br($e->getMessage()));
		}
	...
	public function execute($statement, $params)
	{
		...
		if($result === false) {
			return new DB_Result($this, 0, null, $statement->statement, false, array(), 0, 0, $statement->wrapper->errorInfo()[2], $params);
		}
